...
const PantryDetails = () => {
  ...
  const handleMealChange = (e) => {
    ...
    const instruction =
      preData[selectedDay]?.[selectedMealType]?.[selectedMealTime]
        ?.instructions;
                ...
                {selectedMealTime && (
                  <div className="meal-select">
                    ...
                    <select value={selectedMeal} onChange={handleMealChange}>
                      ...
                      {Object.keys(preData[selectedDay][selectedMealType]).map(
                        (mealTime) => (
                          <option
                            key={mealTime}
                            value={
                              preData[selectedDay][selectedMealType][mealTime]
                                .meal
                            }
                          >
                            {
